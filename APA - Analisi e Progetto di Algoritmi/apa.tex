...
Un algoritmo greedy non si basa su risultati precedenti già calcolati, ma fa una serie di scelte basandosi su quella che risulta essere la scelta migliore ad ogni istante (quando devo fare la scelta).
\\La difficoltà degli algoritmi greedy non sta tanto nello scrivere l'algoritmo in se, ma determinare se l'algoritmo funziona 
