...
\begin{enumerate}
	...
	\item Calcolare il valore delle soluzinoi ottimali, tipicamente in maniera bottom-up, memorizzando i loro valori in tabelle.
...
\paragraph{Il problema} dello scheduling di attività riguarda la gestione di un insime di attività caratterizzate da un tempo di inizio, un tempo di fine e un valore.
L'obiettivo è quello di determinare un insieme di attività mutualmente compatibili il cui valore totle è massimo.
...
Date due sequenze $X$ e $Y$, trovare la più lunga sottosequenza comune di caratteri (non necessariamente consecutivi).\\
