...
Si determini, se esiste, una primitiva $\phi: \R \to \R$ della funzione $f:( -1, +\infty) \to \R$, $f(x) = 2x+ln(x+1)$ tale che $\phi(1)=2\phi(0)$}
...
\domanda{8}{$\lim_{x\to\pm0} \frac{\sin(2^x-1)}{(2^x-1)^2}$}
...
\section{Febbraio 2023}
\subsection{Domande Chiuse}
\paragraph*{nota, le risposte chiuse sono state mischiate, altrimenti quelle giuste erano sempre la A}
\domanda{1A}{La funzione $f:A\to B, f(x)=2-x^6$ è biunivoca se}
\rispostechiuse
{$A=(-\infty,0], B=(-\infty,2]$}
{$A=[0,+\infty), B=[2,+\infty)$}
{$A=\R, B=(-\infty,2]$}
...
\domanda{1B}{La funzione $f:A\to B, f(x)=x^4+4$ è biunivoca se}
\rispostechiuse
{$A=(-\infty,0], B=[4,+\infty)$}
{$A=[0,+\infty), B=[0,+\infty)$}
{$A=\R, B=[4,+\infty)$}
...
\domanda{2A}{Date le funzioni $f(x) = \sin x, g(x) = x^2,h(x)?2+x$, la funzione composta $(h\circ g \circ f)(x)$ è}
\rispostechiuse
{$2+(\sin x)^2$}
{$(2+\sin x)^2$}
{$2+x^2+\sin x$}
...
\domanda{2B}{Date le funzioni $f(x) =\cos(x), g(x)=x^2, h(x)=3-x$ la funzione composta $(h\circ g \circ f)(x)$ è}

\domanda{3A}{Si consideri la successione $a_n = \frac{n^210^n+(-n)^n}{n^7-7^n}$. Quale delle seguenti è corretta?}
\rispostechiuse
{$a_n$ non ha limite}
{$a_n \to +\infty$}
{$a_n \to -\infty$}
...
\domanda{3B}{Si consideri la successione $a_n=\frac{n^2(-10)^n +n^n}{n^7-7^n}$. Quale delle seguenti è corretta?}
\rispostechiuse
{$a_n \to -\infty$}
{$a_n$ non ha limite}
{$a_n \to +\infty$}
