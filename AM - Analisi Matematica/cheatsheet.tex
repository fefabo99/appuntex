...
\emph{Condizione necessaria ma non sufficiente} di convergenza è che il termine generale $a_n$ sia infinitesimo $\limite{n}{+\infty} a_n = 0$.
...
per ricondurami alla sommatoria $\sum^n$ e poi sostituendo l'ipotesi induttiva 
