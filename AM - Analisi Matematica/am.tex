...
risulta:
\begin{equation}
    \underset{n \to \infty}{\lim} s_n \begin{cases}
...
Da cui
\begin{equation*}
    \sum_{k=1}^{n}a_k = \underset{n \to +\infty}{\lim} s_n = b_ - \underset{n \to +\infty}{\lim} b_{n+1} = b_1
\end{equation*}
...
\\Da qui è possibile calcolarne il $\limite{+\infty} s_n = 1$, quindi la serei \emph{converge a 1}.
