...
\definizione{Una \emph{Funzione continua in un punto} è una funzione in cui due limiti sinistro e destro capcolati nel punto coincidono con la valutazione della funzione nel punto.
\\Quindi, diciamo che $f:\R \to \R$ è \emph{continua nel punto $x_0$} se
$$\limite{x}{x_{0}^-} f(x) =\limite{x}{x_{0}^+} f(x) = f(x_0)$$
}


Una funzione continua su un insieme è una funzione continua in ogni punto dell'insieme
\chapter{Successioni}
