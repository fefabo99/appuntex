...
\rispostaaperta{
	...
	\begin{itemize}
		\item $\frac{1}{6}$ è Asintoto Orizzontale per $x\to \pm \infty$.
  		\item $0,\frac{1}{2}$ sono Asintoti Verticali.
	\end{itemize}
	...
	$x+1\geq 0 \to x\geq -1$, $-5x+1\geq 0 \to x\leq \frac{1}{5}$ per il numeratore,
	\\ $3x^2>0 \to \forall x$, $(2x-1)^2>0 \to \forall x$ per il denominatore.
