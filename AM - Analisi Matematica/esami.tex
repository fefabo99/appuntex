...
Siccome però la serie parte da 1, bisogna togliere la somma con n=0, quindi:
\\$= e \frac{1}{1-\frac{1}{e^2}} -1 = \frac{e}{1-\frac{1}{e^2}}-1 
= \frac{e}{\frac{e^2-1}{e^2}}-1 
= e\frac{e^2}{e^2-1}-1 = \frac{e^3}{e^2-1}-1 = \frac{e^3-e^2+1}{e^2-1}
=\frac{e+1}{e^2-1}
$
\\Il risultato mi viene $\frac{e+1}{e^2-1}$ ma dovrebbe essere $\frac{e}{e^2-1}$, quindi bisogna capire cosa ho sbagliato}
\irrisolta
