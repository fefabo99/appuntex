...
\section{Approssimazioni di Taylor e McLaurin}

\subsection{Tayolr}

\paragraph*{\underline{Polinomio di Taylor}} di grado $k$ e centrato in $x_0$:
$$P_k(x)=f(x_0)+f'(x_0)(x-x_0) + \frac{1}{2}f''(x_0)(x-x_0)^2 +... + \frac{1}{k!}f^{(k)}(x_0)(x-x_0)^k$$


\subsection{McLaurin}
\paragraph*{\underline{Polinomio di Mclaurin}} di grado $k$:
