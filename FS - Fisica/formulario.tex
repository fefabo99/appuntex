...
\chapter{Dinamica}
    ...
    è applicata nella stessa direzione dello spostamento.}
        ...
        \begin{quote}
            Il lavoro fatto su una particella è uguale a $\Delta E_k$. L'energia 
    ...
    Potenziale è detta Energia Meccanica, definita come:
        ...
        \paragraph{Principio di conservazione dell'Energia Meccanica} Un oggetto
        tenuto ad altezza $h$ dal suolo non ha Energia Cinetica, ma il suo 
        potenziale Gravitazionale è $U = mgh$. Se lasciato cadere il suo 
        Potenziale Gravitazionale diminiusce, facendo aumentare gradualmente
        la sua Energia Cinetica. La somma dell'Energia Cineta e di quella
        Potenziale Gravitazionale (detta Energia Meccanica) rimane 
        \textbf{costante}.
