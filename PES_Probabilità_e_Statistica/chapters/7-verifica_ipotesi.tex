...
\definizione{
    Il \textbf{p-value} del test è il minimo livello di significatività t.c. i dati
    consentono di \textbf{rifiutare} $H_0$.
}
...
\osservazione{ Se trovo un valore $\alpha$ per cui rifiuto $H_0$, sicuramente rifiuterò $H_0$ per ogni altro valore $\alpha_i$ maggiore di esso.}
