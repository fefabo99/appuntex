...
\subsection{Passaggio parametri - convenzioni base}
...
\end{center}
\begin{itemize}
    \item \$a0 - \$a3: registri argomento per il passaggio dei parametri
    \item \$v0 - \$v1: registri valore per la restituzione dei risultati
\end{itemize}
...
%PAG A-22 spiegazione più approfondita dei registri, andare a vedere e riportare
% negli appunti
% Rivedere esempi PDF procedure

\section{ASM - Catena Programmativa + Linguaggio Assembly}
\section{Syscall}
%END------------------------------------------------------------------------
\end{document}